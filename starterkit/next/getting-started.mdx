...
Depending on which technologies you selected for your starter kit, you'll need to fill in the `.env` file with the necessary environment variables.

### Site

This is the full URL of your site. By default, StarterKit will use port `:3000`.
